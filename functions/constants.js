...
module.exports.VALID_HAND_TYPE = [HAND_LABEL_ROCK,
  HAND_LABEL_PAPER, HAND_LABEL_SCISSORS];
...
MATCH_RESULT_FOR_HAND_SCISSORS[HAND_LABEL_ROCK] =
MATCH_STATE.LOSE; // チョキにグーで勝ち
...
const SPEAK_MESSAGE_RESULT_USER_WIN =
SPEAK_MESSAGE_RESULT_TEMPLATE +
"あなたの勝ちです！おめでとうございます！" + SPEAK_MESSAGE_REPLAY_TEMPLATE;
const SPEAK_MESSAGE_RESULT_USER_DRAW =
SPEAK_MESSAGE_RESULT_TEMPLATE +
"あいこです。次にどの手を出しますか？";
const SPEAK_MESSAGE_RESULT_USER_LOSE =
SPEAK_MESSAGE_RESULT_TEMPLATE + "あなたの負けです。残念でした。" +
SPEAK_MESSAGE_REPLAY_TEMPLATE;
